 ...
 * Contains a brief description of PathCollab and a link to the repository.
 */
export function AboutSection() {
  return (
    <SidebarSection title="About">
      <p className="text-gray-300 leading-relaxed mb-3" style={{ fontSize: '0.875rem' }}>
        PathCollab is a real-time collaborative viewer for whole-slide images. Share your slide with
        colleagues and explore together with synchronized views and live cursors.
      </p>
      <a
